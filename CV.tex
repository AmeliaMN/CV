...
\address{amcnamara@smith.edu \\ www.stat.ucla.edu/$\sim$amelia.mcnamara} 
...
{\bf University of California - Los Angeles,} Los Angeles, CA \hfill Ph.D. June 2015\\ 
{\bf Field:} Statistics \\ 
...
\begin{sSubsection}{Smith College, }{Program in Statistical and Data Science}{2015-2019}
{Visiting Assistant Professor, MassMutual Faculty Fellow}{Northmapton, MA}
\end{sSubsection}
\end{rSection}
...
\begin{pSubsection}{Viewpoints Research Institute, }{Glendale, CA}{2013-2015}{Graduate Intern, Communications Design Group}
...
\begin{rSubsection}{Mobilize Project, }{Los Angeles, CA}{2011-2014}{Graduate Student Researcher, Professional Development Leader
\\ \textbf{Exploring Computer Science Professional Development}. 
...
\\  \textbf{Math and Science Summer Professional Development} 
...
\\ \textbf{Introduction to Data Science Professional Development}
...
\begin{sSubsection}{Statistical Programming-- Past, Present, and Future}{ (seminar) }{December 2014 }{California State University, Fullerton}{Fullerton, CA}
\end{sSubsection}
